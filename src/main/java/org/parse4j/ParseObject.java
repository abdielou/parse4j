...
public class ParseObject {	
	...
	public ParseGeoPoint getParseGeoPoint(String key) {
		...
		if (!(value instanceof ParseGeoPoint)) {
			LOGGER.error("Called getParseGeoPoint(\"{}\") but the value is a {}", key, value.getClass());
			return null;
		}
	...
	public Date getDate(String key) {
		...
		if (!(value instanceof Date)) {
			LOGGER.error("Called getDate(\"{}\") but the value is a {}", key, value.getClass());
			return null;
		}
		return (Date) value;
	}
	...
	public String getString(String key) {
		...
		if (!(value instanceof String)) {
			LOGGER.error("Called getString(\"{}\") but the value is a {}", key, value.getClass());
			return null;
		}
		return (String) value;
	}
